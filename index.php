<?php
/*
 *    pour régler les undefine index on fait comme ça :
 *
 *		avec ISSET
 *		Si la variable $_POST['prixU'] existe, alors $prixU = $_POST['prixU']  sinon elle vaut NULL 
 *		$prixU = isset($_POST['prixU']) ? $_POST['prixU'] : NULL;
 *
 *		ou avec !EMPTY() 
 *		Si la variable $_POST['prixU'] existe et n'est pas vide, alors $prixU = $_POST['prixU']  sinon elle vaut NULL 
 *		$prixU = !empty($_POST['prixU']) ? $_POST['prixU'] : NULL;
 *
 *	  pour les undefine variable : 
 * 	  	if( ! isset( $prixU ) ) $prixU = 0;
 */
?>
<!DOCTYPE html>
<html>
